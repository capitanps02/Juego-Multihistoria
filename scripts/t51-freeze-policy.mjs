export function evaluateT51FreezeTransition({
  ...
  if (activeContentIdentity === frozenContentIdentity) {
    return { mode: 'pre-t51-content-still-active', migrationRouteRegistered: false, route: null };
  }
  ...
  return { mode: 'post-t51-content-route-registered', migrationRouteRegistered: true, route };
}
