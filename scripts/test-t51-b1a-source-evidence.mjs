...
test('B1a source evidence matches the active B1a catalog and differs from freeze only in three fingerprints', async () => {
...
test('a real B1a Session v3 snapshot can migrate to a future identity using registered B1a evidence', async () => {
