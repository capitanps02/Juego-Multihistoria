...
test('the three principal hard couplings remain explicit until a functional batch removes them', async () => {
  const b4 = await json('analysis/T5.1/canon-18-23-b4-legacy-retirement.json');
...
test('repair plan B4 points to the exact retirement handoff', async () => {
