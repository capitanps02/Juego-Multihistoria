...
test('A6 preactivation preserves 388 unique events and activates exactly five owner definitions',async()=>{
...
test('A6 preactivation touches only the selected 23-25 semantic slots',()=>{
