...
test('T5.1 30-34 shifted canonical activations keep migration explicit while using canonical runtime IDs', () => {
  for (const [canonicalId, legacyId] of [['EVT_30_BRIDGE_001','EVT_30_IDN_001'],['EVT_30_STATUS_001','EVT_30_TEAM_001'],['EVT_32_IMPACT_001','EVT_32_TACT_001'],['EVT_33_FIN_001','EVT_33_END_001']]) {
