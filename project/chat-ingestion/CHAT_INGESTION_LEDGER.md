...
- 17 de septiembre de 2026: integrado T5 #123 con oferta formal determinista para las ventanas de enero y verano a los 18 años. La generación `df1b8939…` añade el productor y activa los puentes canónicos de `EVT_18_JAN_001` y `EVT_18_SUM_001`; ruta adyacente `99ec…` → `df1b…`, catálogo congelado, 30 controles de migración/linaje y 11/11 pruebas PlayCanvas.
- 17 de septiembre de 2026: `df1b8939…` publicado en PlayCanvas asset `306862614`. Launch `age18-market=1` recuperó el guardado existente en 9 dic 2026, 6 decisiones, sin errores ni avisos; no se ejecutó ninguna simulación.
- 17 de septiembre de 2026: integrado y publicado el lote técnico T5.1 30–34 re-grounded. La generación `189176d8…` incorpora 27 escenas con paridad técnica documentada y rutas de oferta y autoridad fail-closed; las 18 identidades desplazadas y cinco escenas sin canon ejecutable permanecen fuera de la migración. La arista adyacente `df1b…` → `189176…` libera solo las 27 colisiones `distinct_scene`, preserva historial, pendientes y RNG, y no reescribe seeds. Validación: 82/82 controles de contenido y migración; 11/11 del bundle PlayCanvas. Launch `canon30-34=1` recuperó el guardado existente el 9 dic 2026 con 6 decisiones, sin errores ni avisos; no se ejecutó ninguna simulación.
