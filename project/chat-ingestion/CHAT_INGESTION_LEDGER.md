...
| Migración del guardado publicado a PlayCanvas | 100 % | H `691401e…` está publicado; sucesor `84871…` validado y pendiente de publicación. |
...
| Correcciones funcionales 18–20 | 7 escenas | Dos gates B1b y cinco consumidores causales de seeds; re-ground H → `84871…`. |
