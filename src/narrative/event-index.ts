import type { EventDefinition, EventFamily, GameState, NarrativePhase } from "../core/types.js";

export class EventIndex {
  private byPhase = new Map<NarrativePhase, EventDefinition[]>();
  private byFamily = new Map<EventFamily, EventDefinition[]>();
  private byAge = new Map<number, EventDefinition[]>();

  constructor(public readonly events: EventDefinition[]) {
