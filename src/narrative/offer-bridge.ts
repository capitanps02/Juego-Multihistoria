 ...
 * Their eligibility is deterministic and consumes no RNG. When content declares
 * `offerKinds`, the classification comes exclusively from the shared CareerOffer authority.
 */
