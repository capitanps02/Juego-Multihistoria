...
export type DataValue = Scalar | DataValue[] | { [key: string]: DataValue };

export type EventFamily =
  | "preseason" | "sport" | "team" | "captaincy" | "press" | "agent"
  | "market" | "medical" | "social" | "tactical" | "contract" | "money"
  | "family" | "selection" | "image" | "life" | "legacy" | "conditional";

export type State20Tag =
...
export type State23Tag =
  | "STATE23_ELITE_ROTATION"
  | "STATE23_ELITE_STARTER"
  | "STATE23_TOP_STARTER"
  | "STATE23_SECOND_STAR"
  | "STATE23_LOAN_PROPERTY"
  | "STATE23_ABROAD_BUILD"
  | "STATE23_HOME_ICON"
  | "STATE23_CONTRACT_WAR"
  | "STATE23_INJURY_CROSSROADS"
  | "STATE23_LATE_PRO"
  | "STATE23_FREE_AGENT_RISK"
  | "STATE23_MEDIA_PROFILE";

export type State26Tag =
  | "STATE26_WORLD_ELITE"
  | "STATE26_ELITE_ROTATION"
  | "STATE26_TOP_STARTER"
  | "STATE26_SECOND_STAR"
  | "STATE26_NATIONAL_REGULAR"
  | "STATE26_NATIONAL_FRINGE"
  | "STATE26_ABROAD_ESTABLISHED"
  | "STATE26_HOME_LEADER"
  | "STATE26_BIG_CONTRACT_TRAP"
  | "STATE26_CONTRACT_POWER"
  | "STATE26_INJURY_MANAGEMENT"
  | "STATE26_LATE_BREAKTHROUGH"
  | "STATE26_FREE_AGENT"
  | "STATE26_MEDIA_POWER";


export type State30Tag =
  | "STATE30_WORLD_ICON"
  | "STATE30_GLOBAL_STAR"
...
export type State34Tag =
  | "STATE34_WORLD_ELITE"
  | "STATE34_ELITE_SPECIALIST"
  | "STATE34_REINVENTED_CREATOR"
  | "STATE34_ELITE_CAPTAIN_MENTOR"
  | "STATE34_ONE_CLUB_ICON"
  | "STATE34_HOME_RETURN_LEADER"
  | "STATE34_LATE_BLOOM_PEAK"
  | "STATE34_RICH_LEAGUE_STAR"
  | "STATE34_TRANSATLANTIC_FACE"
  | "STATE34_BIG_CLUB_LUXURY"
  | "STATE34_CONTRACT_TRAP"
  | "STATE34_BODY_MANAGED"
  | "STATE34_BODY_FRAGILE"
  | "STATE34_NT_LEADER"
  | "STATE34_NT_RETIRED"
  | "STATE34_FREE_AGENT_POWER"
  | "STATE34_JOURNEYMAN_VETERAN"
  | "STATE34_RETIREMENT_NEAR"
  | "STATE_EARLY_RETIRED_30_34";
...
export type EndingFamily =
  ...
  | "END_HOME_PRODIGAL"
  | "END_GREAT_PRO"
  | "END_TACTICAL_SECOND_CAREER"
  | "END_JOURNEYMAN_VETERAN"
  | "END_MARKET_SILENCE"
  | "END_BODY_CLOSED_DOOR"
  | "END_ELITE_SPECIALIST"
  | "END_NEW_MARKET_ICON"
  | "END_EARLY_VOLUNTARY"
  | "END_TOO_LONG"
  | "END_RETIRE_ON_HIGH"
  | "END_COMEBACK_FINAL"
  | "END_POLARIZING_WINNER"
  | "END_WEALTH_OVER_GLORY"
  | "END_UNFINISHED_FEELING"
  | "END_STORYBOOK_FAREWELL"
  | "END_NATIONAL_CAPTAIN"
  | "END_CONTRACT_KING";
...
export type NarrativePhase =
  | "18_20" | "20_23" | "23_26" | "26_30" | "30_34" | "34_plus";
...
export interface ScheduledEvent {
  ...
  debug?: {
    candidates: Array<{ id: string; weight: number; factors: Record<string, number> }>;
    rngDraw: number;
  };
}
...
export interface ResolutionResult {
  ...
  presentation?: PresentationSpec;
  debug?: {
    outcomeWeights: Array<{ id: string; weight: number; modifiers: string[] }>;
    rngDraw: number;
  };
}
