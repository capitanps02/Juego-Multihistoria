...
const f=(id:string,family:MicroFeedDefinition["family"],text:string,weight=1,gates?:MicroFeedDefinition["gates"]):MicroFeedDefinition=>({id,ageWindow:[26,29],family,text,weight,gates});
export const MICROFEEDS_26_30:MicroFeedDefinition[]=[
