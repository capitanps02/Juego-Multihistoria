...
const RETIRED_TECHNICAL_PRINCIPAL_IDS = new Set([
  "EVT_20_MATCH_001",
  "EVT_21_CCH_001",
  "EVT_22_LIFE_001"
]);

const BASE_PRINCIPALS_WITHOUT_RETIRED_TECHNICAL_ROWS = PRINCIPAL_EVENTS_20_23.filter(
  event => !RETIRED_TECHNICAL_PRINCIPAL_IDS.has(event.id)
);

export const ACTIVE_PRINCIPAL_EVENTS_20_23 = replaceById(
  BASE_PRINCIPALS_WITHOUT_RETIRED_TECHNICAL_ROWS,
