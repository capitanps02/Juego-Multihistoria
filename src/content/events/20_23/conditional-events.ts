import type { Condition, EventDefinition, Effect } from "../../../core/types.js";
import { ambiguousEvent, flag, n } from "../18_20/helpers.js";

type CRow = { id:string; title:string; gates:Condition[]; age:[number,number]; months?:number[]; effects?:[Effect[],Effect[],Effect[]] };
...
function make(row:CRow):EventDefinition {
...
export const CONDITIONAL_EVENTS_20_23: EventDefinition[] = rows.map(make);
