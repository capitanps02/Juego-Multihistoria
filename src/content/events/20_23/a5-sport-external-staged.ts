...
const EVT_22_TACT_001 = ambiguousEvent({
  ...
  choices:[
    ...
    {id:"MORE_WITH_BALL",label:"Decir que puedes ayudar más con balón",intentTags:["tactical","challenge","identity"],primaryMessage:"Defiendes tu perfil con balón sin afirmar que el plan del técnico vaya a fallar.",secondaryMessage:"La objeción puede abrir una conversación táctica o reducir confianza para este partido concreto.",primaryEffects:[n("control.career",4),n("professional.tacticalReading",2)],secondaryEffects:[n("professional.environmentStability",-2),n("professional.institutionalTrust",-3)],primarySeedTransitions:[seedCreate("SEED_TACTICAL_SACRIFICE",60,{stance:"argue_ball"})],secondarySeedTransitions:[seedCreate("SEED_TACTICAL_SACRIFICE",66,{stance:"argue_ball",role_cost:true})]},
