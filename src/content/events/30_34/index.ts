...
const shiftedAdditionIds=new Set(["EVT_30_BRIDGE_001","EVT_30_STATUS_001","EVT_32_IMPACT_001","EVT_33_FIN_001"]);
const shiftedAdditions=CANONICAL_ADDITIONS_30_34.filter(event=>shiftedAdditionIds.has(event.id));
if(shiftedAdditions.length!==4) throw new Error("Missing one or more owner-prepared A7 shifted additions");
...
export const EVENTS_30_34=[...principal,...shiftedAdditions,richOffer,...CONDITIONAL_EVENTS_30_34];
