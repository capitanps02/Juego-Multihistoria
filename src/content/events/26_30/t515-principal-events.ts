...
const PEAK_IDENTITY_BRIDGE = ambiguousEvent({
  ...
  tags: ["peak_identity", "succession", "adult_peak", "mandatory_transition", "t5_15"],
  canonStatus: "verified"
});

/**
 * Staged T5.15 definitions. They are intentionally NOT merged into EVENTS_26_30
 * until the coordinator lands the adjacent contentIdentity migration and the
 * SEED_PEAK_IDENTITY catalog-origin handoff.
 */
