...
const CEVT_19_AGENT_01 = ambiguousEvent({
  ...
  gates:[{path:"facts.agentOmissionLive",op:"eq",value:true},{path:"facts.activeAgentNpcId",op:"exists"}],
  seedsRead:["SEED_AGENT_OMISSION"],seedsWrite:["SEED_AGENT_OMISSION"],npcRefs:["NPC_PRS_01"],weight:8,
  choices:[
