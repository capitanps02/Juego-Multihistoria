...
export const T510_CONTENT_IDENTITY = "fee2ff875bac7979d3907f5ee1004ef736efa9a257237c6dee629dd8687fe136";
...
export const CONTENT_MIGRATION_ROUTES: readonly ContentMigrationRoute[] = [
  ...
  },
  {
    ...
    targetContentIdentity: T510_CONTENT_IDENTITY,
    schedulerMappings: [
      { kind: "distinct_scene", legacyEventId: "EVT_23_BRIDGE_001", canonicalEventId: "EVT_23_BRIDGE_001", clearCanonicalSeen: true, clearCanonicalCooldown: true },
      { kind: "distinct_scene", legacyEventId: "EVT_23_AGT_001", canonicalEventId: "EVT_23_AGT_001", clearCanonicalSeen: true, clearCanonicalCooldown: true },
      { kind: "distinct_scene", legacyEventId: "EVT_23_BODY_001", canonicalEventId: "EVT_23_BODY_001", clearCanonicalSeen: true, clearCanonicalCooldown: true }
    ]
  }
];
