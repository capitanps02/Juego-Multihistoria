...
Current follow-up integration base: `main@d9cd3cf3b9d1f23ab2f082b66ef4a01f6177e7f2`  
...
Focused QA proves the pending kind is deterministic/read-only, survives save/load, and fails closed to `null` when live terms diverge from `offer.before`. The audit prevents new direct signing bypasses while allowing the quantified legacy backlog only to decrease.
