...
missing contract: frozen authoritative 34+ target identity and adjacent lineage source  
...
issue: current main only has aggregate weekly appearances plus persisted football moments; no authoritative fixture/calendar/squad/result model  
