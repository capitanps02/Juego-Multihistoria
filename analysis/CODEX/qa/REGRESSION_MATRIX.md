...
| sport save authority | persisted facts must be producer-possible and milestone-semantic | `scripts/test-t5-match-model-known-bug.mjs` | **failing/open T5-QA-029 / #212** | sport/save |
