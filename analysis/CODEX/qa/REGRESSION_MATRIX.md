...
| migrations | path adjacent, frozen evidence, no history rewrite | T5.1 migration/freeze suites | covered through generation G | T5.1/session |
| 18–23 | cross-boundary + references | `qa:t5:fast` | smoke only; content work ongoing | content 18–23 |
| 23–30 | causal role provenance | `scripts/test-t51-prs-23-26.mjs` | covered; #109 resolved in generation G | content 23–30 |
...
| content identity | active freeze/registry exact | T5.1 freeze/migration suites | covered through generation G | T5.1/session |
