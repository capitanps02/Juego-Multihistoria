...
export function getCanonCoverage() { return phaseCoverage("18_20"); }
export function getCanonCoverageAll() { return [phaseCoverage("18_20"), phaseCoverage("20_23"), phaseCoverage("23_26"), phaseCoverage("26_30"), phaseCoverage("30_34"), phaseCoverage("34_plus")]; }
